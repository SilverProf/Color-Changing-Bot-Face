...
####	Use the _ready function to run the initialize() function to see what happens.			####
####																							####
####										GOOD LUCK!											####
####																							####
####################################################################################################
...
############################################################################################
func _ready() -> void:
	# Here, we run the the initialize() function to start the color-changing process.
	# This will also cause the on-screen text to change.
	initialize()
